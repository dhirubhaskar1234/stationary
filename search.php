        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                ...
                if (isset($_POST['submit'])) {
                    $search = trim(mysqli_real_escape_string($connection,$_POST['search']));
                    //echo $search;
                }
                if (isset($_GET['page'])) {
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="th">
                        <div class="row">
                            <?php
                            $sql_product="SELECT * FROM `products` WHERE `product_name` LIKE '%".$search."%' AND `active`=1 LIMIT $page_1,16";
                ...
                <?php
                if($count > 0){
                    $sql_pag="SELECT * FROM `products` WHERE `product_name` LIKE '%".$search."%' AND `active`=1";
                        ...
                        <div class="page-number">
                            <ul>
                                ...
                                for ($i=1; $i <= $count_page; $i++) {
                                    ...
                                    if ($page == $i) {
                                        print ' <li class="active "><a class="page-link" href="search/' . $i . '">' . $i . '</a></li>';
                                    } else {
                                        print ' <li><a href="search/' . $i . '">' . $i . '</a></li>';
