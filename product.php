			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                        <?php
                        if (isset($_GET['id'])){
                            $sub_cat_id=clean($_GET['id']);
                            $sql_cat="SELECT * FROM `categories` WHERE `id`=$sub_cat_id";
						...
						<div class="section-title-5 mb-30">
                            <?php if (isset($row_cat['cat_name'])){ ?>
							<h2><?php echo $row_cat['cat_name']; ?></h2>
                            <?php } ?>
						</div><hr>
						<!-- tab-area-start -->
						<div class="tab-content">
							<div class="tab-pane active" id="th">
							    <div class="row">
                                    <?php
                                        $sql_product="SELECT * FROM `products` WHERE `sub_cat`='$sub_cat_id' AND `active`=1 LIMIT $page_1,16";
                                                            ...
                                                            <div class="product-img">
                                                                <a href="details/<?php echo $row_product['id']; ?>/<?php echo $url; ?>">
                                                                    <img src="backend/stationary/uploads/<?php echo $row_product['image']; ?>"
                                                                         alt="<?php echo $row_cat['cat_name']; ?>" class="primary"/>
                                                                </a>
                            ...
                            <!--  <div style="display: flex;justify-content: center;">
                                <button class="btn btn-warning" style="width:30%">Loading <i class="fa fa-spinner" aria-hidden="true"></i></button>
                            </div> -->
						<!-- tab-area-end -->
						<!-- pagination-area-start -->
                        <?php
                            if($count > 0){
                                $sql_pag="SELECT * FROM `products` WHERE `sub_cat`='$sub_cat_id' AND `active`=1";
							...
							<div class="page-number">
								<ul>
                                    ...
                                    for ($i=1; $i <= $count_page; $i++) {
                                        ...
                                        if ($page == $i) {
                                            print ' <li class="active "><a class="page-link" href="product/'.$sub_cat_id.'/'.$url.'/' . $i . '">' . $i . '</a></li>';
                                        } else {
                                            print ' <li><a class="page-link" href="product/'.$sub_cat_id.'/'.$url.'/' . $i . '">' . $i . '</a></li>';
