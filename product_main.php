            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="th">
                        <div class="row">
                            <?php
                            $sql_product="SELECT * FROM `products` WHERE `main_cat`='$cat_id' AND `active`=1 LIMIT $page_1,16";
                ...
                <?php
                if($count > 0){
                    $sql_pag="SELECT * FROM `products` WHERE `main_cat`='$cat_id' AND `active`=1";
                        ...
                        <div class="page-number">
                            <ul>
                                ...
                                for ($i=1; $i <= $count_page; $i++) {
                                    ...
                                    if ($page == $i) {
                                        print ' <li class="active "><a class="page-link" href="categories/'.$cat_id.'/'.$url.'/' . $i . '">' . $i . '</a></li>';
                                    } else {
                                        print ' <li><a href="categories/'.$cat_id.'/'.$url.'/' . $i . '">' . $i . '</a></li>';
